      ...
      @input="handlePasswordInput"
                ...
                <v-container class="text-center">
                  <v-container class="mt-auto d-flex justify-center align-self-center">
                    <v-btn class="mt-8 text-capitalize text-h6 bg-blue font-weight-black" block rounded="xl" size="x-large" @click="onConfirm">Confirmar</v-btn>
                  </v-container>
                  <v-progress-circular class="mt-2" indeterminate color="blue" v-if="progressVisible"></v-progress-circular>
                </v-container>
              </v-form>
            </v-container>
          </v-container>
